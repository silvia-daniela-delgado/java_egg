...
public class guia3_prac_eje7 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" lecturas " + contcorrectas + " cadenas correctas");
        System.out.println(" lecturas " + contincorrectas + " cadenas incorrectas");
    }
}
